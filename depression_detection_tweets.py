...
if __name__ == "__main__":
    ...
    sc_bow: TweetClassifier = TweetClassifier(obj.trainData, 'bow')
    #sc_bow.train()
    ...
    # # Depressive Tweets
    # """
    # # inp = input('Enter your feelings: ')
    # pm = process_message('Extreme sadness, lack of energy, hopelessness ,depression ,hurt')
    # # pm = process_message(inp)
    # # pm = process_message('happy,love,energetic,hopeful')
